...
const Dashboard = () => {
    ...
    const handleAnalyze = async (e) => {
        ...
        setResult(null);
        try {
            const res = await api.post('/api/analyze', { sentence, strictMode });
            setResult(res.data);
            fetchStats();
        } catch (err) {
            console.error(err);
    ...
    const fetchStats = async () => {
        try {
            const res = await api.get('/api/analyze/stats');
            setStats(res.data);
        } catch (err) {
            console.error(err);
        }
    ...
    useEffect(() => {
        ...
        const fetchDailyWord = async () => {
            ...
            if (cached && cachedDate === today) {
                ...
                try {
                    const res = await api.get('/api/daily/word');
    ...
    const handleGetExamples = async (mistakeData, idx) => {
        ...
        try {
            const res = await api.post('/api/analyze/examples', {
